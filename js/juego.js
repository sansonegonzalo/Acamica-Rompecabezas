...
var instrucciones = ['Las fichas se pueden mover en el campo en cualquier dirección: hacia arriba, abajo, derecha, izquierda.', 'Las piezas no pueden salirse del tablero, asi que aprovecha el espacio vacio para reorganizarlas y lograr el objetivo.'];
...
function mostrarInstrucciones(instrucciones) {
    var largoLista = instrucciones.length;
    var contador;

    for(contador = 0; contador < largoLista; contador++){
      mostrarInstruccionEnLista(instrucciones[contador],"lista-instrucciones");
    }
...
function posicionValida(fila, columna) {
  var filaEnGrilla = fila >= 0 && fila <= 2;
  var columnaEnGrilla = columna >= 0 && columna <= 2;

  return (filaEnGrilla && columnaEnGrilla)? true : false;
}
